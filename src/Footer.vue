            ...
            <div class="flex flex-col md:w-1/2 md:pl-12">
                ...
                <nav class="flex flex-wrap list-none -mb-1">
                    <li class="lg:w-1/2 mb-1 w-1/2">
                        <a class="@dark:hover:text-white hover:text-gray-700 transition-all duration-150" href="https://github.com/BraydenTW/react-tailwind-portfolio/">Brayden W. Card Design</a>
                    </li>
                    <hr />
                    ...
                    <li class="lg:w-1/2 mb-1 xl:-ml-18 w-1">
                        <a class="@dark:hover:text-white hover:text-gray-700 transition-all duration-150" href="https://icones.js.org/">icònes.js.org</a>
                    </li>
                </nav>
            </div>
        </div>
