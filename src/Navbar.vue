<template>
    <div class="border-t-10 border-violet-400">
  ...
  <div class="container mx-auto flex flex-wrap p-7 flex-col md:flex-row items-start">
    ...
    <nav class="ml-auto md:mr-auto flex flex-initial flex-wrap items-start text-start text-lg justify-start">
      ...
      <a class="mr-7 py-2 sm:py-1 sm:px-2 hover:text-gray-900 hover:bg-gray-200 rounded-lg hover:underline hover:underline-dashed transition-all duration-150" href="https://github.com/heyimnitho?tab=repositories">Repositories</a>
      <a class="-mx-1 mr-2 py-2 sm:py-1 sm:px-2 hover:text-gray-900 hover:bg-gray-200 rounded-lg hover:underline hover:underline-dashed transition-all duration-150" href="https://open.spotify.com/user/i1ftnp8o2z994a72zglh311rn">Spotify</a>
    </nav>
